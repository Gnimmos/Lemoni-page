...
import './App.css';
import logo from './logos/LOGO-energetic-zone.png'
  ...
  render(){
      ...
      <div className={this.state.changeback} >
              ...
              <Popup trigger={<button style={{color:this.state.color1}} className="about"> About</button>}
                ...
                closeOnDocumentClick>
                  <div className="aboutlemoni">
                    ...
                    <Element style={{color:this.state.color1}} className="aboutlemon" >ABOUT LEMONI RADIO            
        ...
        <body className = "App-body">
              ...
              <Player className="Playerloc" style={{color:this.state.color2}}>
